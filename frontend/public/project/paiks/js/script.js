$(function(){
	...
	var res1=window.matchMedia('screen and (min-width: 1200px) and (max-width: 1339px)');
	var res2=window.matchMedia('screen and (min-width: 1025px) and (max-width: 1199px)');
	var res3=window.matchMedia('screen and (min-width: 320px) and (max-width: 1024px)');
	...
	/* 화면 작을 때 빽스서치 어펜드투 */
	if(resD3 =='block'){$('#paiksSearch').appendTo('#middleContent');};
